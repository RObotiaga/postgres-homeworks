...
SELECT MAX(unit_price), MIN(unit_price) FROM products WHERE discontinued IN ('0')
...
SELECT MAX(unit_price), MIN(unit_price) FROM products WHERE discontinued IN ('0') AND units_in_stock > 20